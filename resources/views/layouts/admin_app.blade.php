  ...
  <div class="main-menu menu-fixed menu-dark menu-accordion menu-shadow" data-scroll-to-active="true">
    <div class="main-menu-content">
      <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
        ...
        <li class=" nav-item">
          <a href="{{ route('vendedores') }}"><i class="la la-newspaper-o"></i>
            <span class="menu-title" data-i18n="nav.support_documentation.main">Vendedores</span>
          </a>
        </li>
        <li class=" nav-item">
          <a href="{{ route('clientes') }}"><i class="la la-image"></i>
